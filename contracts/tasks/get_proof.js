...
async function getProof(txHash) {
  // https://era.zksync.io/docs/dev/how-to/send-message-l2-l1.html
    ...
    const foreignProxyContract = new ethers.Contract(await homeProxyContract.foreignProxy(), RealitioForeignArbitrationProxy.abi, l2Provider);
    ...
    if (result) {
      ...
      try {
        await foreignProxyContract.connect(signer).consumeMessageFromL2(l1BatchNumber, proof.id, l1BatchTxIndex, eventData, proof.proof);
